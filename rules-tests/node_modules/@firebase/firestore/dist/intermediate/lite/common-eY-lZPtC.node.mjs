import { FirebaseError, isCloudWorkstation, pingServer, deepEqual, createMockUserToken, getDefaultEmulatorHostnameAndPort, getModularInstance } from '@firebase/util';
import { randomBytes as randomBytes$1 } from 'crypto';
import { Logger, LogLevel } from '@firebase/logger';
import { inspect } from 'util';
import { Integer } from '@firebase/webchannel-wrapper/bloom-blob';
import { _isFirebaseServerApp, getApp, _getProvider, _removeServiceInstance } from '@firebase/app';
