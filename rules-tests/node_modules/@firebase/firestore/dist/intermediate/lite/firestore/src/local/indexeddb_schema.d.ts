...
import { Document as ProtoDocument, DocumentsTarget as ProtoDocumentsTarget, QueryTarget as ProtoQueryTarget, PipelineQueryTarget as ProtoPipelineQueryTarget, Write as ProtoWrite } from '../protos/firestore_proto_api';
 ...
 */
export type DbQuery = ProtoQueryTarget | ProtoDocumentsTarget | ProtoPipelineQueryTarget;
/**
