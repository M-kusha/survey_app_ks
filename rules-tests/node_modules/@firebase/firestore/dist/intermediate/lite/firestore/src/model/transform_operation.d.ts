 ...
 */
export declare abstract class NumericTransformOperation extends TransformOperation {
    readonly serializer: Serializer;
    readonly operand: ProtoValue;
    constructor(serializer: Serializer, operand: ProtoValue);
}
export declare class NumericIncrementTransformOperation extends NumericTransformOperation {
}
export declare class NumericMinimumTransformOperation extends NumericTransformOperation {
}
export declare class NumericMaximumTransformOperation extends NumericTransformOperation {
}
...
export declare function applyNumericTransformOperationToLocalView(operation: NumericTransformOperation, previousValue: ProtoValue | null, transform: (x: number, y: number) => number): ProtoValue;
export declare function applyNumericMinimumTransformOperationToLocalView(operation: NumericMinimumTransformOperation, previousValue: ProtoValue | null): ProtoValue;
export declare function applyNumericMaximumTransformOperationToLocalView(operation: NumericMaximumTransformOperation, previousValue: ProtoValue | null): ProtoValue;
