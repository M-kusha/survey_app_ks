...
export declare class QueryEngine {
    ...
    getDocumentsMatchingQuery(transaction: PersistenceTransaction, query: QueryOrPipeline, lastLimboFreeSnapshotVersion: SnapshotVersion, remoteKeys: DocumentKeySet): PersistencePromise<DocumentMap>;
    createCacheIndexes(transaction: PersistenceTransaction, query: QueryOrPipeline, context: QueryContext, resultSize: number): PersistencePromise<void>;
    /**
