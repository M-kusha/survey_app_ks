 ...
 * @internal
 */
export declare function resultChangesFromSnapshot(querySnapshot: RealtimePipelineSnapshot, includeMetadataChanges: boolean): ResultChange[];
/**
 * @internal
 */
export declare class RealtimePipelineSnapshot {
    readonly _snapshot: ViewSnapshot;
    ...
    private _cachedChangesIncludeMetadataChanges?;
    /** @hideconstructor */
    constructor(pipeline: RealtimePipeline, _snapshot: ViewSnapshot, _listenOptions: ListenOptions);
    /** An array of all the documents in the `QuerySnapshot`. */
