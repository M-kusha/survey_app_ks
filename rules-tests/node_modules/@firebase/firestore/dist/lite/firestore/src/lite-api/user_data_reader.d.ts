 ...
 */
export declare function parseData(input: unknown, context: ParseContext, options?: {
 ...
 */
export declare function parseScalarValue(value: unknown, context: ParseContext, options?: {
    preferIntegers: boolean;
}): ProtoValue | null;
/**
