...
import { QueryOrPipeline, TargetOrPipeline } from '../core/pipeline-util';
 ...
 * for that `Target`.
 */
export declare function localStoreAllocateTarget(localStore: LocalStore, target: TargetOrPipeline): Promise<TargetData>;
/**
 * Returns the TargetData as seen by the LocalStore, including updates that may
 * have not yet been persisted to the TargetCache.
 */
export declare function localStoreGetTargetData(localStore: LocalStore, transaction: PersistenceTransaction, target: TargetOrPipeline): PersistencePromise<TargetData | null>;
/**
 ...
 */
export declare function localStoreExecuteQuery(localStore: LocalStore, query: QueryOrPipeline, usePreviousResults: boolean): Promise<QueryResult>;
...
export declare function localStoreGetCachedTarget(localStore: LocalStore, targetId: TargetId): Promise<TargetOrPipeline | null>;
export declare function localStoreGetDocuments(localStore: LocalStore, pipeline: CorePipeline): Promise<DocumentMap>;
/**
