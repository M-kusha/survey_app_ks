...
export declare function newTestFirestore(projectId?: string, databaseId?: string | undefined): Firestore;
...
export declare function querySnapshotWithQuery(query: InternalQuery, docsToAdd: {
    [key: string]: JsonObject<unknown>;
}): QuerySnapshot;
