...
import { QueryOrPipeline, TargetOrPipeline } from '../../../src/core/pipeline-util';
...
export declare class ClientMemoryState {
    ...
    queryMapping: ObjectMap<TargetOrPipeline, TargetId>;
...
export declare class SpecBuilder {
     ...
     */
    runAsTest(name: string, tags: string[], usePersistence: boolean, convertToPipeline: boolean): Promise<void>;
     ...
     * stream disconnect.
     */
    restoreListen(query: QueryOrPipeline, resumeToken: string, expectedCount?: number): this;
    userUnlistens(query: QueryOrPipeline, shouldRemoveWatchTarget?: boolean): this;
