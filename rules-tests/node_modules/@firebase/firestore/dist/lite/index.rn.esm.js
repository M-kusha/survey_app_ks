import { _registerComponent as t, registerVersion as e, SDK_VERSION as s } from "@firebase/app";

import { Component as i } from "@firebase/component";

import { _ as a, F as n, a as r, b as o, c as h, d as c, O as u, q as l, e as _, f, g as d, h as g, i as m, j as A, k as p, l as w, m as y, P, n as D, o as b, p as v, r as F, s as k, C as O, t as S, u as q, D as x, v as C, S as j, w as z, x as tt, y as et, z as st, A as it } from "./common-DPlpxwn8.rn.esm.js";
...
import { deepEqual as nt, getModularInstance as rt } from "@firebase/util";
 ...
 */ function aggregateQuerySnapshotEqual(t, e) {
    return l(t.query, e.query) && nt(t.data(), e.data());
}
 ...
 */ class WriteBatch {
    ...
    update(t, e, s, ...i) {
        ...
        // performing validation.
                let n;
        return n = "string" == typeof (e = rt(e)) || e instanceof D ? b(this._dataReader, "WriteBatch.update", a._key, e, s, i) : v(this._dataReader, "WriteBatch.update", a._key, e), 
        this._mutations.push(n.toMutation(a._key, P.exists(!0))), this;
    }
    /**
...
function __PRIVATE_validateReference(t, e) {
    if ((t = rt(t)).firestore !== e) throw new k(O.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ let ht = class Transaction {
    ...
    async commit() {
        ...
        })), await S(this.datastore, this.mutations), this.committed = !0;
    }
    recordVersion(t) {
        let e;
     ...
     */    precondition(t) {
        ...
        return !this.writtenDocs.has(t.toString()) && e ? e.isEqual(j.min()) ? P.exists(!1) : P.updateTime(e) : P.none();
    }
    /**
 ...
 */ (t)) throw t;
 // Failure will be handled by AsyncQueue
     ...
     * exists.
     */    K(t) {
        for (const e of this.S) if (e.timerId === t) return !0;
        return !1;
    }
    /**
 ...
 */ class Transaction {
    ...
    update(t, e, s, ...i) {
        ...
        // performing validation.
                let n;
        return n = "string" == typeof (e = rt(e)) || e instanceof D ? b(this._dataReader, "Transaction.update", a._key, e, s, i) : v(this._dataReader, "Transaction.update", a._key, e), 
 ...
 */ !function __PRIVATE_registerFirestore() {
    c(`${s}_lite`), t(new i("firestore/lite", ((t, {instanceIdentifier: e, options: s}) => {
    ...
    e("firestore-lite", ot, "rn"), e("firestore-lite", ot, "esm2020");
}();
