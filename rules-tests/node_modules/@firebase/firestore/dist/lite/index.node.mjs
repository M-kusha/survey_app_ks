...
export { AggregateField, AggregateQuerySnapshot, DocumentSnapshot, FieldPath, Firestore, FirestoreError, Transaction, WriteBatch, aggregateFieldEqual, aggregateQuerySnapshotEqual, average, count, getAggregate, getCount, queryEqual, runTransaction, sum, writeBatch };
