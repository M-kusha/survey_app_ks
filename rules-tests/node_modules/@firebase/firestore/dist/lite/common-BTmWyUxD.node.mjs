...
class DatabaseInfo {
     ...
     * XMLHTTPRequest
     */
    constructor(databaseId, appId, persistenceKey, host, ssl, forceLongPolling, autoDetectLongPolling, longPollingOptions, useFetchStreams, isUsingEmulator, apiKey, _customHeaders, grpcFlowControlWindow) {
...
function valueEquals(left, right, options) {
    if (left === right) {
        return true;
    }
    ...
    switch (leftType) {
        ...
        case 9 /* TypeOrder.ArrayValue */:
            return arrayEquals(left.arrayValue.values || [], right.arrayValue.values || [], (l, r) => valueEquals(l, r, options));
...
function numberEquals(left, right, options) {
...
function objectEquals(left, right, options) {
 ...
 */
function toNumber(serializer, value, options) {
...
function makeDatabaseInfo(databaseId, appId, persistenceKey, apiKey, settings) {
    return new DatabaseInfo(databaseId, appId, persistenceKey, settings.host, settings.ssl, settings.experimentalForceLongPolling, settings.experimentalAutoDetectLongPolling, cloneLongPollingOptions(settings.experimentalLongPollingOptions), settings.useFetchStreams, settings.isUsingEmulator, apiKey, settings._customHeaders, settings.grpcFlowControlWindow);
}
...
class FirestoreSettingsImpl {
    constructor(settings) {
        ...
        if (settings.grpcFlowControlWindow !== undefined) {
            if (typeof settings.grpcFlowControlWindow !== 'number' ||
                settings.grpcFlowControlWindow <= 0 ||
                settings.grpcFlowControlWindow > 2147483647 ||
                !Number.isInteger(settings.grpcFlowControlWindow)) {
                throw new FirestoreError(Code.INVALID_ARGUMENT, 'grpcFlowControlWindow must be a positive integer and cannot exceed 2147483647');
            }
...
function customHeadersEqual(a, b) {
    if (a === b) {
        return true;
    }
    if (!a || !b) {
 ...
 */
function parseData(input, context, options) {
 ...
 */
function parseScalarValue(value, context, options) {
    value = getModularInstance(value);
    if (value === null) {
...
export { arrayRemove as $, CollectionReference as A, Bytes as B, Code as C, DocumentSnapshot as D, DocumentReference as E, Firestore as F, FieldValue as G, GeoPoint as H, QueryCompositeFilterConstraint as I, QueryConstraint as J, QueryDocumentSnapshot as K, LiteAuthCredentialsProvider as L, QueryEndAtConstraint as M, QueryFieldFilterConstraint as N, ObjectValue as O, Precondition as P, Query as Q, QueryLimitConstraint as R, SnapshotVersion as S, QueryOrderByConstraint as T, QuerySnapshot as U, VerifyMutation as V, QueryStartAtConstraint as W, Timestamp as X, VectorValue as Y, addDoc as Z, and as _, LiteAppCheckTokenProvider as a, arrayUnion as a0, collection as a1, collectionGroup as a2, connectFirestoreEmulator as a3, deleteDoc as a4, deleteField as a5, doc as a6, documentId as a7, endAt as a8, endBefore as a9, isPlainObject as aA, isCollectionGroupQuery as aB, isDocumentQuery as aC, queryNormalizedOrderBy as aD, toMapValue as aE, toNumber as aF, hardAssert as aG, toStringValue as aH, toPipelineValue as aI, DOCUMENT_KEY_NAME as aJ, parseData as aK, FieldPath$1 as aL, FieldFilter as aM, CompositeFilter as aN, isUserData as aO, invokeExecutePipeline as aP, getDoc as aa, getDocs as ab, getFirestore as ac, increment as ad, initializeFirestore as ae, limit as af, limitToLast as ag, maximum as ah, minimum as ai, or as aj, orderBy as ak, query as al, refEqual as am, serverTimestamp as an, setDoc as ao, setLogLevel as ap, snapshotEqual as aq, startAfter as ar, startAt as as, terminate as at, updateDoc as au, vector as av, where as aw, isString as ax, isCollectionReference as ay, isNumber as az, LiteUserDataWriter as b, applyFirestoreDataConverter as c, databaseIdFromApp as d, FieldPath as e, fail as f, parseUpdateVarargs as g, parseUpdateData as h, DeleteMutation as i, FirestoreError as j, fieldPathFromArgument as k, cast as l, getDatastore as m, newUserDataReader as n, mapToArray as o, parseSetData as p, queryEqual as q, invokeRunAggregationQueryRpc as r, invokeCommitRpc as s, isNullOrUndefined as t, isPermanentError as u, logDebug as v, invokeBatchGetDocumentsRpc as w, DocumentKey as x, logError as y, setSDKVersion as z };
//# sourceMappingURL=common-BTmWyUxD.node.mjs.map
