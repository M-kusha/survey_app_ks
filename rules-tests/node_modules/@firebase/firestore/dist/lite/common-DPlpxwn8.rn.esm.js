import { FirebaseError as E, isCloudWorkstation as T, base64 as V, DecodeBase64StringError as R, pingServer as I, deepEqual as nt, createMockUserToken as N, getDefaultEmulatorHostnameAndPort as L, getModularInstance as rt } from "@firebase/util";

import { Logger as B, LogLevel as M } from "@firebase/logger";

import { Integer as Q } from "@firebase/webchannel-wrapper/bloom-blob";

import { _isFirebaseServerApp as U, getApp as $, _getProvider, _removeServiceInstance as K } from "@firebase/app";
 ...
 * limitations under the License.
 */
const G = new B("@firebase/firestore");
...
function a(e, ...t) {
    if (G.logLevel <= M.DEBUG) {
        const r = t.map(__PRIVATE_argToString);
        G.debug(`Firestore (${s}): ${e}`, ...r);
    }
}

function st(e, ...t) {
    if (G.logLevel <= M.ERROR) {
        const r = t.map(__PRIVATE_argToString);
        G.error(`Firestore (${s}): ${e}`, ...r);
    }
}
 ...
 */ function __PRIVATE_logWarn(e, ...t) {
    if (G.logLevel <= M.WARN) {
        const r = t.map(__PRIVATE_argToString);
        G.warn(`Firestore (${s}): ${e}`, ...r);
    }
}
...
/** AppCheck token provider for the Lite SDK. */ class o {
    constructor(e, t) {
        this.se = t, this.appCheck = null, this.oe = null, U(e) && e.settings.appCheckToken && (this.oe = e.settings.appCheckToken), 
        t.onInit((e => {
            this.appCheck = e;
        }));
    }
...
/** The default database name for a project. */ const W = "(default)";
 ...
 */ class DatabaseId {
    constructor(e, t) {
        this.projectId = e, this.database = t || W;
    }
    static empty() {
        return new DatabaseId("", "");
    }
    get isDefaultDatabase() {
        return this.database === W;
    }
    isEqual(e) {
 ...
 */ class BasePath {
    ...
    static extractNumericId(e) {
        return Q.fromString(e.substring(4, e.length - 2));
    }
}
 ...
 * @internal
 */ let Z = class FieldPath extends BasePath {
    construct(e, t, r) {
     ...
     */    isKeyField() {
        return 1 === this.length && this.get(0) === Y;
    }
    /**
     * The field designating the key of a document.
     */    static keyField() {
        return new FieldPath([ Y ]);
    }
    /**
...
function __PRIVATE_generateUniqueDebugId() {
    return null === ee ? ee = function __PRIVATE_generateInitialUniqueDebugId() {
        return 268435456 + Math.round(2147483648 * Math.random());
    }() : ee++, "0x" + ee.toString(16);
}
...
class __PRIVATE_RestConnection {
    ...
    constructor(e) {
        ...
        this.ue = t + "://" + e.host, this._e = `projects/${r}/databases/${n}`, this.ce = this.databaseId.database === W ? `project_id=${r}` : `project_id=${r}&database_id=${n}`;
    }
    le(e, t, r, n, i) {
        const s = __PRIVATE_generateUniqueDebugId(), o = this.he(e, t.toUriEncodedString());
        a(te, `Sending RPC '${e}' ${s}:`, o, r);
        const u = {
        ...
        return this.me(e, o, u, r, c).then((t => (a(te, `Received RPC '${e}' ${s}: `, t), 
        t)), (t => {
            throw __PRIVATE_logWarn(te, `RPC '${e}' ${s} failed with error: `, t, "url: ", o, "request:", r), 
            t;
        }));
    }
    de(e, t, r, n, i, s) {
 ...
 */ (ie = ne || (ne = {}))[ie.OK = 0] = "OK", ie[ie.CANCELLED = 1] = "CANCELLED", 
...
/** Converts a Base64 encoded string to a binary string. */ function __PRIVATE_decodeBase64(e) {
    try {
        ...
        V.decodeStringToByteArray(e, se));
    } catch (e) {
        throw e instanceof R ? new __PRIVATE_Base64DecodeError("Invalid base64 string: " + e) : e;
    }
}
...
class Timestamp {
     ...
     */    static fromMillis(e) {
        const t = Math.floor(e / 1e3), r = Math.floor((e - 1e3 * t) * ue);
    ...
    t) {
        ...
        if (e < ae) throw new k(O.INVALID_ARGUMENT, "Timestamp seconds out of range: " + e);
     ...
     */    toMillis() {
        return 1e3 * this.seconds + this.nanoseconds / ue;
    }
    _compareTo(e) {
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const _e = "__type__", ce = "__max__", le = {}, he = "__vector__", fe = "value";
...
function __PRIVATE_typeOrder(e) {
    ...
    function __PRIVATE_isMaxValue(e) {
        return (((e.mapValue || {}).fields || {}).__type__ || {}).stringValue === ce;
    }
    /**
 * @license
 ...
 */ (e) ? 9007199254740991 /* TypeOrder.MaxValue */ : 
    ...
    function __PRIVATE_isVectorValue(e) {
        const t = (e?.mapValue?.fields || {})[_e]?.stringValue;
        return t === he;
    }
    ...
    switch (r) {
      ...
      case 10 /* TypeOrder.VectorValue */ :
        return function __PRIVATE_compareVectors(e, t) {
            const r = e.fields || {}, n = t.fields || {}, i = r[fe]?.arrayValue, s = n[fe]?.arrayValue, o = __PRIVATE_primitiveComparator(i?.values?.length || 0, s?.values?.length || 0);
            if (0 !== o) return o;
 ...
 */ class FieldMask {
     ...
     */    unionWith(e) {
        let t = new SortedSet(Z.comparator);
 ...
 */ (t);
        ...
        e.has(Z.keyField().canonicalString()) || t.Ie.push(new OrderBy(Z.keyField(), r));
    }
    return t.Ie;
}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const ut = "ComponentProvider", Te = new Map;
 ...
 */ const Pe = 1048576, Ve = "firestore.googleapis.com", Re = !0;
...
class FirestoreSettingsImpl {
    constructor(e) {
        if (void 0 === e.host) {
            ...
            this.host = Ve, this.ssl = Re;
        } else this.host = e.host, this.ssl = e.ssl ?? Re;
        ...
        e._customHeaders && (this._customHeaders = {
            ...
            if (-1 !== e.cacheSizeBytes && e.cacheSizeBytes < Pe) throw new k(O.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
...
class n {
     ...
     */    _terminate() {
        return function __PRIVATE_removeComponents(e) {
            const t = Te.get(e);
            t && (a(ut, "Removing Datastore"), Te.delete(e), t.terminate());
...
function getFirestore(e, t) {
    const r = "object" == typeof e ? e : $(), n = "string" == typeof e ? e : t || "(default)", i = _getProvider(r, "firestore/lite").getImmediate({
        identifier: n
    });
    if (!i._initialized) {
        const e = L("firestore");
 ...
 */ function connectFirestoreEmulator(e, t, r, i = {}) {
    ...
    s && I(`https://${u}`), o.host !== Ve && o.host !== u && __PRIVATE_logWarn("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used.");
    const _ = {
        ...o,
        host: u,
        ssl: s,
    ...
    // enviornments which might call `connectFirestoreEmulator` multiple times as a standard practice.
        ...
        if ("string" == typeof i.mockUserToken) t = i.mockUserToken, r = User.MOCK_USER; else {
            ...
            t = N(i.mockUserToken, e._app?.options.projectId);
 ...
 */ function terminate(e) {
    return e = f(e, n), K(e.app, "firestore/lite"), e._delete();
}
...
/** A "context" object passed around while parsing user data. */ class ParseContextImpl {
    ...
    validatePathSegment(e) {
        ...
        if (__PRIVATE_isWrite(this.dataSource) && Ae.test(e)) throw this.createError('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ function __PRIVATE_fieldPathFromDotSeparatedString(e, t, r) {
    if (t.search(Ie) >= 0) throw createError(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`, e, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, r);
    try {
...
class AbstractUserDataWriter {
     ...
     */    convertVectorValue(e) {
        const t = e.fields?.[fe].arrayValue?.values?.map((e => __PRIVATE_normalizeNumber(e.doubleValue)));
