import { ax as e, ay as t, az as r, h as s, O as i, aA as o, s as a, aB as u, aC as _, X as l, av as c, aD as E, a7 as p, e as f, aE as T, aF as x, aG as d, C as A, aH as h, w as P, aI as V, aJ as R, aK as m, a6 as g, aL as $, aM as w, aN as v, aO as D, G as y, E as F, g as O, f as U, k as b, j as S, aP as C, F as M } from "./common-DPlpxwn8.rn.esm.js";

export { B as Bytes, n as FieldPath, H as FieldValue, I as GeoPoint, Q as Query, L as QueryDocumentSnapshot, W as Timestamp } from "./common-DPlpxwn8.rn.esm.js";
 ...
 */ class OptionsUtil {
    ...
    _getKnownOptions(s, o) {
        ...
        // SERIALIZE KNOWN OPTIONS
            ...
            if (i in s) {
                const _ = s[i];
                let l;
                if (u.nestedOptions && e(_)) {
                    l = {
                        mapValue: {
                            fields: new OptionsUtil(u.nestedOptions).getOptionsProto(o, _)
                        }
                    };
                } else _ && (l = t(_, o) ?? void 0);
                l && a.set(r.fromServerFormat(u.serverName), l);
            }
        }
        return a;
    }
    getOptionsProto(e, i, o) {
        ...
        // APPLY OPTIONS OVERRIDES
                if (o) {
            const i = new Map(s(o, ((s, i) => [ r.fromServerFormat(i), void 0 !== s ? t(s, e) : null ])));
            a.setAll(i);
        }
 ...
 */ function __PRIVATE_valueToDefaultExpr$1(t) {
    let r;
    return t instanceof Expression ? t : (r = e(t) ? __PRIVATE__map(t) : t instanceof Array ? array(t) : __PRIVATE__constant(t, void 0), 
    r);
}
 ...
 */ function __PRIVATE_vectorToExpr$1(e) {
    ...
    if (e instanceof l) return constant(e);
    if (Array.isArray(e)) return constant(c(e));
 ...
 */ class Expression {
     ...
     */    asBoolean() {
        ...
        throw new a("invalid-argument", `Conversion of type ${typeof this} to BooleanExpression not supported.`);
    }
    subtract(e) {
...
function _field(e, t) {
    return new Field("string" == typeof e ? E === e ? p()._internalPath : f("field", e) : e._internalPath, t);
}
 ...
 */ class Constant extends Expression {
     ...
     */    _readUserData(e) {
        e = this._methodName ? e.contextWith({
            methodName: this._methodName
        }) : e, __PRIVATE_isFirestoreValue(this._protoValue) || (this._protoValue = t(this.value, e));
    }
}
...
function timestampTruncate(e, t, r) {
    const s = _(t) ? __PRIVATE_valueToDefaultExpr$1(t) : t;
...
class __PRIVATE_PipelineValueExpression extends Expression {
     ...
     * @internal
     */    _toProto(e) {
        return x(this.pipeline._toProto(e));
    }
    /**
     * @internal
     */    _readUserData(e) {
...
function __PRIVATE_isSelectable(e) {
    const t = e;
    return t.selectable && _(t.alias) && __PRIVATE_isExpr(t.expr);
}
...
function __PRIVATE_isAliasedAggregate(e) {
    const t = e;
    return _(t.alias) && t.aggregate instanceof AggregateFunction;
}
...
class __PRIVATE_Aggregate extends Stage {
     ...
     */    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ T(e, this.accumulators), T(e, this.groups) ]
        };
    }
    _readUserData(e) {
...
class __PRIVATE_DocumentsSource extends Stage {
    ...
    constructor(e, t) {
        if (super(t), !e || 0 === e.length) throw new a(A.INVALID_ARGUMENT, "Empty document paths are not allowed in DocumentsSource");
        const r = e.map((e => e.startsWith("/") ? e : "/" + e)), s = new Set(r);
        if (s.size !== r.length) throw new a(A.INVALID_ARGUMENT, "Duplicate document paths are not allowed in DocumentsSource");
        this._ = r, this.l = s;
    }
    /**
     * @internal
...
class __PRIVATE_Sample extends Stage {
    ...
    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ d(e, this.rate), u(this.mode) ]
        };
    }
    _readUserData(e) {
        super._readUserData(e);
...
class __PRIVATE_Replace extends Stage {
    ...
    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ this.map._toProto(e), u(__PRIVATE_Replace.p) ]
        };
    }
    _readUserData(e) {
 ...
 */ function __PRIVATE_readUserDataHelper(e, t) {
    return h(e) ? e._readUserData(t) : Array.isArray(e) ? e.forEach((e => e._readUserData(t))) : e instanceof Map ? e.forEach((e => e._readUserData(t))) : Object.values(e).forEach((e => e._readUserData(t))), 
    e;
}
...
function __PRIVATE_selectablesToObject(e) {
    ...
    for (const r of e) {
        ...
        s = r.expr) : P(21273, {
            selectable: r
        }), void 0 !== t[e]) throw new a("invalid-argument", `Duplicate alias or field '${e}'`);
        t[e] = s;
    }
    return t;
}
 ...
 */
    return function __PRIVATE_valueToDefaultExpr(t) {
        ...
        r = e(t) ? map(t) : t instanceof Array ? array(t) : 
        /**
...
class Pipeline {
    ...
    removeFields(e, ...t) {
        // Process argument union(s) from method overloads
        const r = __PRIVATE_isField(e) || _(e) ? {} : e, s = (__PRIVATE_isField(e) || _(e) ? [ e, ...t ] : e.fields).map((e => _(e) ? field(e) : e)), i = new __PRIVATE_RemoveFields(s, r);
        // Add stage to the pipeline
    ...
    select(e, ...t) {
        // Process argument union(s) from method overloads
        const r = __PRIVATE_isSelectable(e) || _(e) ? {} : e, s = __PRIVATE_selectablesToMap(__PRIVATE_isSelectable(e) || _(e) ? [ e, ...t ] : e.selections), i = new __PRIVATE_Select(s, r);
        // Add stage to the pipeline
        return this._addStage(i);
    }
    where(e) {
    ...
    limit(e) {
        // Process argument union(s) from method overloads
        const t = V(e) ? {} : e, r = V(e) ? e : e.limit, s = new __PRIVATE_Limit(r, t);
        // Add stage to the pipeline
        return this._addStage(s);
    }
    distinct(e, ...t) {
        // Process argument union(s) from method overloads
        const r = _(e) || __PRIVATE_isSelectable(e) ? {} : e, s = __PRIVATE_selectablesToMap(_(e) || __PRIVATE_isSelectable(e) ? [ e, ...t ] : e.groups), i = new __PRIVATE_Distinct(s, r);
        // Add stage to the pipeline
        return this._addStage(i);
    }
    aggregate(e, ...t) {
        ...
        const r = __PRIVATE_isAliasedAggregate(e) ? {} : e, s = __PRIVATE_isAliasedAggregate(e) ? [ e, ...t ] : e.accumulators, i = __PRIVATE_isAliasedAggregate(e) ? [] : e.groups ?? [], o = function __PRIVATE_aliasedAggregateToMap(e) {
            return e.reduce(((e, t) => {
                if (void 0 !== e.get(t.alias)) throw new a("invalid-argument", `Duplicate alias or field '${t.alias}'`);
 ...
 */ (s), u = __PRIVATE_selectablesToMap(i), _ = new __PRIVATE_Aggregate(u, o, r);
    ...
    replaceWith(e) {
        // Process argument union(s) from method overloads
        const t = _(e) || __PRIVATE_isExpr(e) ? {} : e, r = __PRIVATE_fieldOrExpression(_(e) || __PRIVATE_isExpr(e) ? e : e.map), s = new __PRIVATE_Replace(r, t);
        // Add stage to the pipeline
        return this._addStage(s);
    }
    sample(e) {
        ...
        const t = V(e) ? {} : e;
        let r, s;
        V(e) ? (r = e, s = "documents") : V(e.documents) ? (r = e.documents, s = "documents") : (r = e.percentage, 
        s = "percent");
        // Create stage object
 ...
 */
    ...
    unnest(e, t) {
        ...
        _(i) && (r.indexField = _field(i, "unnest"));
        // Create stage object
     ...
     */    rawStage(t, r, s) {
        // Convert user land convenience types to internal types
        const i = r.map((t => t instanceof Expression || t instanceof AggregateFunction ? t : e(t) ? function __PRIVATE__mapValue(e) {
            const t = new Map;
...
function __PRIVATE_toPipelineStages(e, t) {
    let r;
    r = R(e) ? t.pipeline().collectionGroup(e.collectionGroup) : m(e) ? t.pipeline().documents([ g(t, e.path.canonicalString()) ]) : t.pipeline().collection(e.path.canonicalString());
    // filters
        for (const t of e.filters) r = r.where(__PRIVATE_toPipelineBooleanExpr(t));
    // orders
        const s = $(e), i = s.map((e => field(e.field.canonicalString()).exists()));
 ...
 */ class PipelineSource {
    ...
    collection(e) {
        // Process argument union(s) from method overloads
        const t = _(e) || D(e) ? {} : e, r = _(e) || D(e) ? e : e.collection;
        // Validate that a user provided reference is for the same Firestore DB
        D(r) && this._validateReference(r);
        // Convert user land convenience types to internal types
                const s = _(r) ? r : r.path, i = new __PRIVATE_CollectionSource(s, t), o = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "collection");
        // Create stage object
                // Add stage to the pipeline
    ...
    documents(e) {
        ...
        r.filter((e => e instanceof y)).forEach((e => this._validateReference(e)));
        // Convert user land convenience types to internal types
        const s = r.map((e => _(e) ? e : e.path)), i = new __PRIVATE_DocumentsSource(s, t), o = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "documents");
        // Create stage object
                // Add stage to the pipeline
        return i._readUserData(o), this._createPipeline([ i ]);
    }
    ...
    _validateReference(e) {
        ...
        if (!t.isEqual(this.databaseId)) throw new a(A.INVALID_ARGUMENT, `Invalid ${e instanceof F ? "CollectionReference" : "DocumentReference"}. The project ID ("${t.projectId}") or the database ("${t.database}") does not match the project ID ("${this.databaseId.projectId}") and database ("${this.databaseId.database}") of the target database of this Pipeline.`);
    }
}
 ...
 */ class PipelineResult {
    ...
    get(e) {
        ...
        const t = this._fields.field(f("DocumentSnapshot.get", e));
 ...
 */ function execute(e) {
    if (!e._db) return Promise.reject(new a(A.FAILED_PRECONDITION, "This pipeline was created without a database (e.g., as a subcollection pipeline) and cannot be executed directly. It can only be used as part of another pipeline."));
    const t = O(e._db), r = U(e._db, M), s = b(r).createContext(3 /* UserDataSource.Argument */ , "execute");
    e._readUserData(s);
    const i = new S(r), o = new __PRIVATE_StructuredPipelineOptions({}, {});
    o._readUserData(s);
    ...
    return C(t, u).then((t => {
        ...
        const s = t.length > 0 ? t[0].executionTime?.toTimestamp() : void 0, o = t.filter((e => !!e.fields)).map((e => new PipelineResult(i, e.fields, e.key?.path ? new y(r, null, e.key) : void 0, e.createTime?.toTimestamp(), e.updateTime?.toTimestamp())));
