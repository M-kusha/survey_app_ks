...
import { p as property, d as da, _ as __PRIVATE_FirebaseAuthCredentialsProvider, a as __PRIVATE_FirebaseAppCheckTokenProvider, b as __PRIVATE_databaseIdFromApp, O as ObjectValue, t as ta, s, c as aa, C as CompositeFilter, Q as Query, e as __PRIVATE_queryWithAddedFilter, f as __PRIVATE_queryWithEndAt, l as la, g as __PRIVATE_parseQueryValue, F as FieldFilter, h as __PRIVATE_queryWithLimit, i as OrderBy, j as __PRIVATE_queryWithAddedOrderBy, k as __PRIVATE_isPipeline, m as __PRIVATE_newPipelineComparator, n as __PRIVATE_newQueryComparator, o as __PRIVATE_AutoId, q as __PRIVATE_queryWithStartAt, u as ua, r as __PRIVATE_parseSetData, P as Precondition, v as FieldPath, w as __PRIVATE_parseUpdateVarargs, x as __PRIVATE_parseUpdateData, y as __PRIVATE_DeleteMutation, z as ra, A as doc, B as queryEqual, D as oa, E as __PRIVATE_firestoreClientDeleteAllFieldIndexes, G as __PRIVATE_logDebug, H as __PRIVATE_logWarn, I as __PRIVATE_validateJSON, J as __PRIVATE_newSerializer, K as __PRIVATE_createBundleReaderSync, L as __PRIVATE_BundleLoader, M as fromDocument, N as DocumentKey, R as ResourcePath, S as __PRIVATE_firestoreClientWrite, T as __PRIVATE_mapToArray, U as __PRIVATE_AggregateImpl, V as __PRIVATE_firestoreClientRunAggregateQuery, X, W as __PRIVATE_firestoreClientGetDocumentViaSnapshotListener, Y as __PRIVATE_firestoreClientGetDocumentFromLocalCache, Z as __PRIVATE_firestoreClientGetDocumentsViaSnapshotListener, $ as __PRIVATE_firestoreClientGetDocumentsFromLocalCache, a0 as __PRIVATE_validatePositiveNumber, a1 as __PRIVATE_newQueryForPath, a2 as __PRIVATE_firestoreClientListen, a3 as loadBundle, a4 as namedQuery, a5 as __PRIVATE_firestoreClientAddSnapshotsInSyncListener, a6 as __PRIVATE_fromBundledQuery, a7 as DocumentSet, a8 as ViewSnapshot, a9 as __PRIVATE_documentKeySet, aa as __PRIVATE_firestoreClientTransaction, ab as __PRIVATE_fieldPathFromDotSeparatedString, ac as IndexSegment, ad as FieldIndex, ae as IndexState, af as __PRIVATE_firestoreClientSetIndexConfiguration, ag as __PRIVATE_queryNormalizedOrderBy, ah as __PRIVATE_refValue, ai as __PRIVATE_isServerTimestamp, aj as Bound, ak as __PRIVATE_isCollectionGroupQuery, al as __PRIVATE_valueDescription, am as l, an as __PRIVATE_setTestingHooksSpi, ao as __PRIVATE_firestoreClientSetPersistentCacheIndexAutoCreationEnabled, ap as AbstractUserDataWriter, aq as Bytes, ar as __PRIVATE_MemoryOfflineComponentProvider, as as OnlineComponentProvider, at as __PRIVATE_LruGcMemoryOfflineComponentProvider, au as __PRIVATE_MultiTabOfflineComponentProvider, av as __PRIVATE_IndexedDbOfflineComponentProvider, aw as __PRIVATE_setSDKVersion } from './common-DugxmK6F.esm.js';
export { ax as CACHE_SIZE_UNLIMITED, ay as CollectionReference, az as FieldValue, aA as GeoPoint, aB as LoadBundleTask, aC as Timestamp, aD as VectorValue, aE as _ByteString, aF as _DatabaseId, aG as _EmptyAppCheckTokenProvider, aH as _EmptyAuthCredentialsProvider, aI as _FieldPath, aJ as _debugAssert, aK as _internalAggregationQueryToProtoRunAggregationQueryRequest, aL as _internalQueryToProtoQueryTarget, aM as _isBase64Available, aN as _validateIsNotUsedTogether, aO as arrayRemove, aP as arrayUnion, aQ as clearIndexedDbPersistence, aR as collection, aS as collectionGroup, aT as connectFirestoreEmulator, aU as deleteField, aV as disableNetwork, aW as documentId, aX as enableIndexedDbPersistence, aY as enableMultiTabIndexedDbPersistence, aZ as enableNetwork, a_ as getFirestore, a$ as increment, b0 as initializeFirestore, b1 as maximum, b2 as minimum, b3 as refEqual, b4 as serverTimestamp, b5 as setLogLevel, b6 as terminate, b7 as vector, b8 as waitForPendingWrites } from './common-DugxmK6F.esm.js';
...
function __PRIVATE_validateHasExplicitOrderByForLimitToLast(t) {
    if ("L" /* LimitType.Last */ === t.limitType && 0 === t.explicitOrderBy.length) throw new s(aa.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
function query(t, e, ...n) {
    ...
    e instanceof AppliableConstraint && r.push(e), r = r.concat(n), function __PRIVATE_validateQueryConstraintArray(t) {
        ...
        if (e > 1 || e > 0 && n > 0) throw new s(aa.INVALID_ARGUMENT, "InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.");
    }
    /**
 * @license
 * Copyright 2020 Google LLC
 ...
 */ class QueryFieldFilterConstraint extends QueryConstraint {
    ...
    _parse(t) {
        const e = la(t.firestore), n = function __PRIVATE_newQueryFilter(t, e, n, r, s$1, o, i) {
            let a;
            if (s$1.isKeyField()) {
                if ("array-contains" /* Operator.ARRAY_CONTAINS */ === o || "array-contains-any" /* Operator.ARRAY_CONTAINS_ANY */ === o) throw new s(aa.INVALID_ARGUMENT, `Invalid Query. You can't perform '${o}' queries on documentId().`);
            ...
            a = __PRIVATE_parseQueryValue(n, e, i, 
            /* allowArrays= */ "in" /* Operator.IN */ === o || "not-in" /* Operator.NOT_IN */ === o);
            const u = FieldFilter.create(s$1, o, a);
            return u;
 ...
 */ class QueryOrderByConstraint extends QueryConstraint {
    ...
    _apply(t) {
        const e = function __PRIVATE_newQueryOrderBy(t, e, n) {
            if (null !== t.startAt) throw new s(aa.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
            if (null !== t.endAt) throw new s(aa.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
...
/** Helper function to create a bound from a document or fields */ function __PRIVATE_newQueryBoundFromDocOrFields(t, e, n, r) {
    if (n[0] = getModularInstance(n[0]), n[0] instanceof Jt) return function __PRIVATE_newQueryBoundFromDocument(t, e, n, r, s$1) {
        ...
        // results.
                for (const n of __PRIVATE_queryNormalizedOrderBy(t)) if (n.field.isKeyField()) o.push(__PRIVATE_refValue(e, r.key)); else {
...
function __PRIVATE_parseDocumentIdValue(t, e, n) {
    if ("string" == typeof (n = getModularInstance(n))) {
        if ("" === n) throw new s(aa.INVALID_ARGUMENT, "Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!__PRIVATE_isCollectionGroupQuery(e) && -1 !== n.indexOf("/")) throw new s(aa.INVALID_ARGUMENT, `Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
        const r = e.path.child(ResourcePath.fromString(n));
        if (!DocumentKey.isDocumentKey(r)) throw new s(aa.INVALID_ARGUMENT, `Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${r}' is not because it has an odd number of segments (${r.length}).`);
        return __PRIVATE_refValue(t, new DocumentKey(r));
    }
    if (n instanceof X) return __PRIVATE_refValue(t, n._key);
    throw new s(aa.INVALID_ARGUMENT, `Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${__PRIVATE_valueDescription(n)}.`);
}
 ...
 */ function __PRIVATE_validateDisjunctiveFilterElements(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new s(aa.INVALID_ARGUMENT, `Invalid Query. A non-empty array is required for '${e.toString()}' filters.`);
}
 ...
 */ function __PRIVATE_validateNewFieldFilter(t, e) {
    ...
    throw n === e.op ? new s(aa.INVALID_ARGUMENT, `Invalid query. You cannot use more than one '${e.op.toString()}' filter.`) : new s(aa.INVALID_ARGUMENT, `Invalid query. You cannot use '${e.op.toString()}' filters with '${n.toString()}' filters.`);
}
...
class __PRIVATE_LiteUserDataWriter extends AbstractUserDataWriter {
    ...
    convertReference(t) {
        ...
        return new X(this.firestore, /* converter= */ null, e);
    }
}
 ...
 */ function getAggregateFromServer(t, e) {
    ...
    return __PRIVATE_firestoreClientRunAggregateQuery(r, t._query, o).then((e => 
    /**
 ...
 */
    function __PRIVATE_convertToAggregateQuerySnapshot(t, e, n) {
        const r = new ua(t), s = new AggregateQuerySnapshot(e, r, n);
        return s;
    }
    /**
 * @license
 ...
 */ class DocumentSnapshot extends Jt {
     ...
     */    toJSON() {
        if (this.metadata.hasPendingWrites) throw new s(aa.FAILED_PRECONDITION, "DocumentSnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");
 ...
 */ class QuerySnapshot {
     ...
     */    docChanges(t = {}) {
        ...
        if (e && this._snapshot.excludesMetadataChanges) throw new s(aa.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        ...
        function __PRIVATE_changesFromSnapshot(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((n => {
                    __PRIVATE_isPipeline(t._snapshot.query) ? __PRIVATE_newPipelineComparator(t._snapshot.query) : __PRIVATE_newQueryComparator(t.query._query);
     ...
     */    toJSON() {
        if (this.metadata.hasPendingWrites) throw new s(aa.FAILED_PRECONDITION, "QuerySnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                const t = {};
...
function querySnapshotFromJSON(t, e, n) {
    if (__PRIVATE_validateJSON(e, QuerySnapshot._jsonSchema)) {
        ...
        const h = ViewSnapshot.fromInitialDocuments(a, l, __PRIVATE_documentKeySet() /* Zero mutated keys signifies no pending writes. */ , 
        /* fromCache= */ false, 
        /* hasCachedResults= */ false), d = new Query(t, n || null, a);
...
class WriteBatch {
    ...
    set(t, e, n) {
        ...
        const r = __PRIVATE_validateReference(t, this._firestore), s = __PRIVATE_applyFirestoreDataConverter(r.converter, e, n), o = __PRIVATE_parseSetData(this._dataReader, "WriteBatch.set", r._key, s, null !== r.converter, n);
    ...
    update(t, e, n, ...r) {
        ...
        // performing validation.
                let o;
        return o = "string" == typeof (e = getModularInstance(e)) || e instanceof FieldPath ? __PRIVATE_parseUpdateVarargs(this._dataReader, "WriteBatch.update", s._key, e, n, r) : __PRIVATE_parseUpdateData(this._dataReader, "WriteBatch.update", s._key, e), 
        this._mutations.push(o.toMutation(s._key, Precondition.exists(true))), this;
    }
    /**
    ...
    _verifyNotCommitted() {
        if (this._committed) throw new s(aa.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }
}

function __PRIVATE_validateReference(t, e) {
    if ((t = getModularInstance(t)).firestore !== e) throw new s(aa.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ let Ut = class Transaction {
    ...
    update(t, e, n, ...r) {
        ...
        // performing validation.
                let o;
        return o = "string" == typeof (e = getModularInstance(e)) || e instanceof FieldPath ? __PRIVATE_parseUpdateVarargs(this._dataReader, "Transaction.update", s._key, e, n, r) : __PRIVATE_parseUpdateData(this._dataReader, "Transaction.update", s._key, e), 
 ...
 */ function runTransaction(t, e, n) {
    ...
    const o = oa(t);
    return __PRIVATE_firestoreClientTransaction(o, (n => e(new Transaction(t, n))), r);
}
 ...
 */ function getDoc(t) {
    t = ra(t, X);
    const e = ra(t.firestore, da), n = oa(e);
...
function setDoc(t, e, n) {
    t = ra(t, X);
    const r = ra(t.firestore, da), o = __PRIVATE_applyFirestoreDataConverter(t.converter, e, n), i = la(r);
    return executeWrite(r, [ __PRIVATE_parseSetData(i, "setDoc", t._key, o, null !== t.converter, n).toMutation(t._key, Precondition.none()) ]);
}

function updateDoc(t, e, n, ...r) {
    t = ra(t, X);
    const o = ra(t.firestore, da), i = la(o);
    let a;
    a = "string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = getModularInstance(e)) || e instanceof FieldPath ? __PRIVATE_parseUpdateVarargs(i, "updateDoc", t._key, e, n, r) : __PRIVATE_parseUpdateData(i, "updateDoc", t._key, e);
    return executeWrite(o, [ a.toMutation(t._key, Precondition.exists(true)) ]);
}
 ...
 * the document.
 */ function addDoc(t, e) {
    const n = ra(t.firestore, da), r = doc(t), o = __PRIVATE_applyFirestoreDataConverter(t.converter, e), i = la(t.firestore);
    return executeWrite(n, [ __PRIVATE_parseSetData(i, "addDoc", r._key, o, null !== t.converter, {}).toMutation(r._key, Precondition.exists(false)) ]).then((() => r));
}
...
function onSnapshot(t, ...e) {
    ...
    let i, a, u;
    if (t instanceof X) a = ra(t.firestore, da), u = __PRIVATE_newQueryForPath(t._key.path), i = {
        next: n => {
        ...
        const n = ra(t, Query);
        a = ra(n.firestore, da), u = n._query;
        const o = new ua(a);
        i = {
            next: t => {
    ...
    const c = oa(a);
    return __PRIVATE_firestoreClientListen(c, u, o, i);
}

function onSnapshotResume(t, e, ...n) {
    const r = getModularInstance(t), s$1 = 
    /**
 ...
 */ (e);
    ...
    "QuerySnapshot" === s$1.bundleSource) {
        let t = null;
 ...
 */
        return function __PRIVATE_onSnapshotQuerySnapshotBundle(t, e, n, r, s) {
            let o, i = false;
            const a = loadBundle(t, e.bundle);
            return a.then((() => namedQuery(t, e.bundleName))).then((t => {
                if (t && !i) {
 ...
 */ (r, s$1, o, t, n[i]);
    ...
    if ("DocumentSnapshot" === s$1.bundleSource) {
        ...
        return function __PRIVATE_onSnapshotDocumentSnapshotBundle(t, e, n, r, s) {
            ...
            return a.then((() => {
                if (!i) {
                    const i = new X(t, s || null, DocumentKey.fromPath(e.bundleName));
                    o = onSnapshot(i, n || {}, r);
                }
            })).catch((t => (r.error && r.error(t), () => {}))), () => {
                i || (i = true, o && o());
...
function onSnapshotsInSync(t, e) {
    t = ra(t, da);
    const n = oa(t), r = __PRIVATE_isPartialObserver(e) ? e : {
        next: e
    };
 ...
 */ function __PRIVATE_convertToDocSnapshot(t, e, n) {
    const r = n.docs.get(e._key), s = new ua(t);
...
function writeBatch(t) {
    return t = ra(t, da), oa(t), new WriteBatch(t, (e => executeWrite(t, e)));
}
...
function __PRIVATE_registerFirestore(c, l = true) {
    __PRIVATE_setSDKVersion(SDK_VERSION), _registerComponent(new Component("firestore", ((t, {instanceIdentifier: e, options: n}) => {
        const r = t.getProvider("app").getImmediate(), u = new da(new __PRIVATE_FirebaseAuthCredentialsProvider(t.getProvider("auth-internal")), new __PRIVATE_FirebaseAppCheckTokenProvider(r, t.getProvider("app-check-internal")), __PRIVATE_databaseIdFromApp(r, e), r);
        return n = {
            useFetchStreams: l,
            ...n
        }, u._setSettings(n), u;
    }), "PUBLIC").setMultipleInstances(true)), registerVersion(Wt, $t, c), 
    // BUILD_TARGET will be replaced by values like esm, cjs, etc during the compilation
    registerVersion(Wt, $t, "esm2020");
}();

export { AbstractUserDataWriter, AggregateField, AggregateQuerySnapshot, Bytes, X as DocumentReference, DocumentSnapshot, FieldPath, da as Firestore, s as FirestoreError, PersistentCacheIndexManager, Query, QueryCompositeFilterConstraint, QueryConstraint, QueryDocumentSnapshot, QueryEndAtConstraint, QueryFieldFilterConstraint, QueryLimitConstraint, QueryOrderByConstraint, QuerySnapshot, QueryStartAtConstraint, SnapshotMetadata, Transaction, WriteBatch, __PRIVATE_AutoId as _AutoId, DocumentKey as _DocumentKey, TestingHooks as _TestingHooks, ra as _cast, __PRIVATE_logWarn as _logWarn, addDoc, aggregateFieldEqual, aggregateQuerySnapshotEqual, and, average, count, deleteAllPersistentCacheIndexes, deleteDoc, disablePersistentCacheIndexAutoCreation, doc, documentSnapshotFromJSON, enablePersistentCacheIndexAutoCreation, endAt, endBefore, oa as ensureFirestoreConfigured, executeWrite, getAggregateFromServer, getCountFromServer, getDoc, getDocFromCache, getDocFromServer, getDocs, getDocsFromCache, getDocsFromServer, getPersistentCacheIndexManager, limit, limitToLast, loadBundle, memoryEagerGarbageCollector, memoryLocalCache, memoryLruGarbageCollector, namedQuery, onSnapshot, onSnapshotResume, onSnapshotsInSync, or, orderBy, persistentLocalCache, persistentMultipleTabManager, persistentSingleTabManager, query, queryEqual, querySnapshotFromJSON, runTransaction, setDoc, setIndexConfiguration, snapshotEqual, startAfter, startAt, sum, updateDoc, where, writeBatch };
