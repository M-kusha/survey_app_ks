import { _ as a, f as e, F as s, E as t, V as n, c as i, v as r, a as o, A as c, b as l, d as u, e as p, m as h, g as b, p as d, h as m, i as f, j as w, k as g, l as _, n as T, o as P, q as x, r as y, s as E, t as A, u as R, w as I, x as v, y as M, z as O, B as V, C as S, D, G as j, H as q, I as F, J as C, K as L, L as $, M as N, N as U, O as G, P as W, Q as k, R as B, S as K, T as z, U as H, W as J, X as Q, Y as X, Z as Y, $ as Z, a0 as aa, a1 as ea, a2 as sa, a3 as ta, a4 as na, a5 as ia, a6 as ra, a7 as oa, a8 as la, a9 as ua, aa as pa, ab as ha, ac as da, ad as ma } from "./common-C7mVdMAg.rn.js";
...
let fa = class Pipeline {
    ...
    removeFields(s, ...t) {
        // Process argument union(s) from method overloads
        const n = g(s) || a(s) ? {} : s, i = (g(s) || a(s) ? [ s, ...t ] : s.fields).map((s => a(s) ? e(s) : s)), r = new _(i, n);
        // Add stage to the pipeline
    ...
    select(e, ...s) {
        // Process argument union(s) from method overloads
        const t = f(e) || a(e) ? {} : e, n = __PRIVATE_selectablesToMap(f(e) || a(e) ? [ e, ...s ] : e.selections), i = new y(n, t);
        // Add stage to the pipeline
        return this._addStage(i);
    }
    where(a) {
    ...
    limit(a) {
        // Process argument union(s) from method overloads
        const e = R(a) ? {} : a, s = R(a) ? a : a.limit, t = new v(s, e);
        // Add stage to the pipeline
        return this._addStage(t);
    }
    distinct(e, ...s) {
        // Process argument union(s) from method overloads
        const t = a(e) || f(e) ? {} : e, n = __PRIVATE_selectablesToMap(a(e) || f(e) ? [ e, ...s ] : e.groups), i = new M(n, t);
        // Add stage to the pipeline
        return this._addStage(i);
    }
    aggregate(a, ...e) {
 ...
 */ (n), o = __PRIVATE_selectablesToMap(i), c = new V(o, r, t);
    ...
    replaceWith(e) {
        // Process argument union(s) from method overloads
        const s = a(e) || j(e) ? {} : e, t = __PRIVATE_fieldOrExpression(a(e) || j(e) ? e : e.map), n = new $(t, s);
        // Add stage to the pipeline
        return this._addStage(n);
    }
    sample(a) {
        ...
        const e = R(a) ? {} : a;
        let s, t;
        R(a) ? (s = a, t = "documents") : R(a.documents) ? (s = a.documents, t = "documents") : (s = a.percentage, 
        t = "percent");
        // Create stage object
                const n = new N(s, t, e);
        // Add stage to the pipeline
...
class PipelineSource {
    ...
    collection(e) {
        // Process argument union(s) from method overloads
        const s = a(e) || z(e) ? {} : e, t = a(e) || z(e) ? e : e.collection;
        // Validate that a user provided reference is for the same Firestore DB
        z(t) && this._validateReference(t);
        // Convert user land convenience types to internal types
                const n = a(t) ? t : t.path, i = new H(n, s), r = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "collection");
        // Create stage object
                // Add stage to the pipeline
    ...
    documents(e) {
        ...
        // Convert user land convenience types to internal types
        const n = t.map((e => a(e) ? e : e.path)), i = new Y(n, s), r = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "documents");
        // Create stage object
                // Add stage to the pipeline
        return i._readUserData(r), this._createPipeline([ i ]);
    }
