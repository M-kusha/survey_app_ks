...
import { PipelineQueryTarget as ProtoPipelineQueryTarget } from '../protos/firestore_proto_api';
...
export declare function fromDbTarget(serializer: LocalSerializer, dbTarget: DbTarget): TargetData;
...
export declare function fromPipelineTarget(target: ProtoPipelineQueryTarget, serializer: JsonProtoSerializer): CorePipeline;
