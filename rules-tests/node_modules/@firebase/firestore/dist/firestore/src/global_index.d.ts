...
declare type StructuredPipeline = firestoreV1ApiClientInterfaces.StructuredPipeline;
...
interface BundledQuery {
    ...
    limitType?: LimitType$1 | null;
}
/** LimitType enum. */
type LimitType$1 = 'FIRST' | 'LAST';
 ...
 * ```
 */
declare class RealtimePipeline {
    /**
     * @internal
     * @private
     */
...
type PipelineFlavor = 'exact' | 'augmented' | 'keyless';
type PipelineSourceType = 'collection' | 'collection_group' | 'database' | 'documents';
type QueryOrPipeline = Query$1 | CorePipeline;
type TargetOrPipeline = Target | CorePipeline;
 ...
 */
declare function constant(value: number, options?: {
...
declare class ParseContextImpl implements ParseContext {
    ...
    readonly ignoreUndefinedProperties: boolean;
    readonly fieldTransforms: FieldTransform[];
    readonly fieldMask: FieldPath$1[];
    /**
     ...
     * compromised).
     */
    constructor(settings: ContextSettings, databaseId: DatabaseId, serializer: JsonProtoSerializer, ignoreUndefinedProperties: boolean, fieldTransforms?: FieldTransform[], fieldMask?: FieldPath$1[]);
    ...
    childContextForFieldPath(field: FieldPath$1): ParseContextImpl;
...
declare class Pipeline$1 implements ProtoSerializable<Pipeline$2>, UserData {
     ...
     * @private
     */
    _userDataWriter: AbstractUserDataWriter | undefined;
    /**
     * @internal
     * @private
     */
     ...
     * @private
     */
    userDataReader: UserDataReader | undefined, 
    /**
     * @internal
     * @private
     */
...
declare class PipelineResult<AppModelType = DocumentData> {
     ...
     * @param listenOptions
     */
    constructor(userDataWriter: AbstractUserDataWriter, fields: ObjectValue, ref?: DocumentReference, createTime?: Timestamp$1, updateTime?: Timestamp$1, metadata?: SnapshotMetadata, listenOptions?: ListenOptions);
    /**
     * @private
     * @internal
     * @param userDataWriter
     ...
     * @param listenOptions
     */
    static fromDocument(userDataWriter: AbstractUserDataWriter, doc: Document, ref?: DocumentReference, metadata?: SnapshotMetadata, listenOptions?: ListenOptions): PipelineResult;
    /**
