 ...
 */
import { CollectionReference, DocumentData, DocumentReference, Firestore, MemoryLocalCache, PersistentLocalCache, PrivateSettings, Query, QuerySnapshot, SnapshotListenOptions } from './firebase_export';
...
export declare function itIf(condition: boolean | 'only'): Mocha.TestFunction | Mocha.PendingTestFunction | Mocha.ExclusiveTestFunction;
export {};
