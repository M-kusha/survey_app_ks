...
import { FirestoreError, Bytes, _isBase64Available, setLogLevel as setLogLevel$1, doc, addDoc, refEqual, snapshotEqual, _debugAssert, query, where, orderBy, limit, limitToLast, startAt, startAfter, endBefore, endAt, queryEqual, getDocsFromCache, getDocsFromServer, getDocs, QuerySnapshot as QuerySnapshot$1, onSnapshot, DocumentReference as DocumentReference$1, _DocumentKey, collection, setDoc, updateDoc, deleteDoc, getDocFromCache, getDocFromServer, getDoc, DocumentSnapshot as DocumentSnapshot$1, _DatabaseId, _logWarn, connectFirestoreEmulator, enableNetwork, disableNetwork, _validateIsNotUsedTogether, waitForPendingWrites, onSnapshotsInSync, collectionGroup, runTransaction, ensureFirestoreConfigured, WriteBatch as WriteBatch$1, executeWrite, loadBundle, namedQuery, QueryDocumentSnapshot as QueryDocumentSnapshot$1, AbstractUserDataWriter, _cast, enableIndexedDbPersistence, enableMultiTabIndexedDbPersistence, clearIndexedDbPersistence, FieldPath as FieldPath$1, _FieldPath, serverTimestamp, deleteField, arrayUnion, arrayRemove, increment, CACHE_SIZE_UNLIMITED, Timestamp, GeoPoint } from '@firebase/firestore';
