(function exposeLegalCopy(global) {
  ...
  const copy = Object.freeze({
    en: Object.freeze({
      ...
      privacy_intro:
        'EchoMeet lets a company run surveys and quizzes, agree on meeting times, and keep private notes. It is a personal project published to demonstrate the software rather than a commercial service, and this policy describes exactly what it does with your data — nothing is collected for advertising, analytics or resale.',
      ...
      privacy_visibility_body:
        'Your notes are private to you; no administrator and no other member can read them. Your name and profile photo are visible to the members of your company, because a survey result or a meeting vote is meaningless without knowing whose it is. Your answers to a survey or quiz, and your score, are visible to the administrators and moderators of that company. Your meeting votes are visible to members of that company. Nothing you do is visible to members of any other company, and none of it is public.',
      ...
      privacy_security_body:
        'Every connection is encrypted in transit. Access is decided by rules evaluated on Google’s servers, per document, not by the app on your phone — so a modified client cannot read what it is not entitled to. An email address must be verified before it can join a company. Grading material for quizzes is stored apart from the questions members can read, and scores are computed on the server so an answer key never reaches a participant’s device.',
      privacy_retention_title: 'How long it is kept',
      privacy_retention_body:
        'Your data is kept while your account exists. When you request deletion, EchoMeet removes your sign-in, your profile, your photo, your notification tokens, your notes, your survey and quiz participation, your meeting votes, and any ban records naming you; surveys and meetings you created for a company can remain for that company with your authorship marker removed. Closing a company schedules it for deletion seven days later, at which point its surveys, quizzes, answers and meetings are deleted — its members are released, not deleted, and keep their accounts and notes. Deletion removes these records from the live database; copies held inside Google’s infrastructure for operational resilience expire on Google’s own schedule.',
      ...
      deletion_data_body:
        'The trusted deletion process targets the private profile, profile photo, notification tokens, notes, survey or quiz participation, meeting votes, and ban references. Shared company content can remain with an anonymous author marker. Copies held inside Google’s infrastructure for operational resilience expire on Google’s own schedule.',
    ...
    de: Object.freeze({
      ...
      privacy_collect_body:
        'Für ein Konto: Ihre E-Mail-Adresse, Ihr Name und Ihr Geburtsdatum. Ihr Passwort speichert EchoMeet nie – Firebase Authentication verwahrt es und bestätigt lediglich, ob ein Anmeldeversuch dazu passt. Während der Nutzung: Ihre Unternehmenszugehörigkeit, Ihre Rolle und Ihr Freigabestatus dort, ein optionales Profilbild, ein Benachrichtigungstoken für jedes Gerät, auf dem Sie Benachrichtigungen erlauben, Ihre bevorzugte Benachrichtigungssprache, Ihre privaten Notizen, Ihre Antworten und Ergebnisse in Umfragen und Quizzen sowie die Termine, zu denen Sie zugesagt haben. Administrative Vorgänge innerhalb eines Unternehmens – Freigaben, Rollenwechsel, Entfernungen, Sperren – werden mit Urheber und Zeitpunkt festgehalten.',
      ...
      deletion_data_body:
        'Der vertrauenswürdige Löschprozess erfasst privates Profil, Profilbild, Benachrichtigungstokens, Notizen, die Teilnahme an Umfragen oder Quizzen, Terminabstimmungen und Sperrverweise. Gemeinsam genutzte Unternehmensinhalte können mit einer anonymen Autorenmarkierung bestehen bleiben. Kopien innerhalb der Infrastruktur von Google zur Betriebssicherheit verfallen nach dem Zeitplan von Google.',
    ...
    sq: Object.freeze({
      ...
      privacy_collect_body:
        'Për të krijuar një llogari: adresa e emailit, emri dhe datëlindja. Fjalëkalimin EchoMeet nuk e ruan kurrë – Firebase Authentication e mban dhe vetëm konfirmon nëse një përpjekje hyrjeje përputhet. Gjatë përdorimit: kompania të cilës i bëheni anëtar, roli dhe gjendja e miratimit tuaj atje, një fotografi profili opsionale, një token njoftimi për çdo pajisje ku lejoni njoftimet, gjuha e preferuar e njoftimeve, shënimet private, përgjigjet dhe rezultatet në anketa e kuize, dhe oraret e takimeve për të cilat thoni se mund të vini. Veprimet administrative brenda një kompanie – miratime, ndryshime roli, heqje, bllokime – regjistrohen bashkë me atë që i bëri dhe kohën.',
      ...
      privacy_security_body:
        'Çdo lidhje është e enkriptuar gjatë transmetimit. Qasjen e vendosin rregulla që vlerësohen në serverat e Google, dokument për dokument, dhe jo aplikacioni në telefonin tuaj – kështu një klient i modifikuar nuk mund të lexojë atë që nuk i takon. Një adresë emaili duhet të verifikohet para se të bashkohet me një kompani. Materiali i vlerësimit për kuizet ruhet veçmas nga pyetjet që anëtarët lexojnë, dhe rezultatet llogariten në server, kështu që çelësi i përgjigjeve nuk arrin kurrë në pajisjen e një pjesëmarrësi.',
      privacy_retention_title: 'Sa gjatë ruhen',
      privacy_retention_body:
        'Të dhënat ruhen sa kohë ekziston llogaria juaj. Kur kërkoni fshirjen, EchoMeet heq hyrjen, profilin, fotografinë, tokenët e njoftimeve, shënimet, pjesëmarrjen në anketa e kuize, votat për takime dhe shënimet e bllokimit që përmendin ju; anketat dhe takimet që krijuat për një kompani mund të mbeten për atë kompani, pa shenjën e autorësisë tuaj. Mbyllja e një kompanie planifikon fshirjen e saj shtatë ditë më vonë; pas kësaj fshihen anketat, kuizet, përgjigjet dhe takimet e saj – anëtarët lirohen, nuk fshihen, dhe ruajnë llogarinë e shënimet. Fshirja i heq këto të dhëna nga baza e të dhënave aktive; kopjet brenda infrastrukturës së Google për vazhdimësi operative skadojnë sipas afateve të Google.',
      ...
      deletion_data_body:
        'Procesi i besuar i fshirjes synon profilin privat, fotografinë e profilit, tokenët e njoftimeve, shënimet, pjesëmarrjen në anketa ose kuize, votat për takime dhe referencat e bllokimit. Përmbajtja e përbashkët e kompanisë mund të mbetet me një shënim anonim të autorit. Kopjet brenda infrastrukturës së Google për vazhdimësi operative skadojnë sipas afateve të Google.',
